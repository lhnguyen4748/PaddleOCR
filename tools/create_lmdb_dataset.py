...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_list", type=str, default="./dataset/train_labels.txt")
    parser.add_argument("--save_path", type=str, default="./train_data/data_lmdb_release/training")
    args = parser.parse_args()

    os.makedirs(args.save_path, exist_ok=True)
    train_data_list = get_datalist(args.data_dir, args.data_list, 800)
